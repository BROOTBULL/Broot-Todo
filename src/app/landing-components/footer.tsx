      ...
      <div className="flex flex-col items-center md:px-16 px-5 h-fit md:h-60 py-1 md:py-5">
        <div className="flex md:flex-row flex-col justify-between w-full">
          <div className="flex flex-col">
            <div className="text-3xl font-bold text-slate-300 cursor-default flex flex-row items-end md:gap-2">
                <Image src="/media/BrootW.png" className="h-8 w-6" alt="Logo" width={30} height={30} />
                <div className="mt-4">TodoList</div></div>
            <div className="text-sm md:max-w-80 md:my-6 my-2">
          ...
          <div className=" flex flex-row md:gap-8 justify-between">
            <div className="flex flex-col m-2 gap-3">
              <div className="text-xl font-bold text-indigo-300 cursor-default">Features</div>
              <div className="cursor-pointer text-lg hover:bg-slate-800 rounded-lg p-1">How it works</div>
              <div className="cursor-pointer text-lg hover:bg-slate-800 rounded-lg p-1">About Us</div>
              <div className="cursor-pointer text-lg hover:bg-slate-800 rounded-lg p-1">Pricing</div>
            </div>
            <div className="flex flex-col m-2 gap-3">
              <div className="text-xl font-bold text-indigo-300 cursor-default">Contact Us</div>
              <div className=" text-lg flex flex-row items-center p-1 cursor-pointer hover:bg-slate-800 rounded-lg">
